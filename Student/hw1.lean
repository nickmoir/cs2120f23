...
#eval imp true true -- false
#eval imp true false -- true
#eval imp false true -- false
#eval imp false false -- false
...
def glue_funs : (g : Nat → Bool) (f : String → Nat) (s : String)
| g, f, a => (g (f s))
